...
.setColor('#ffffff') 
.setAuthor(`Cool MedyaOto Cevap Komutları`, client.user.avatarURL())
.setDescription(`<a:Cool Medya:749380925619437619> Cool Medyabotumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
